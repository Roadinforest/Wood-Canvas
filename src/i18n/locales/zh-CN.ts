...
export const zhCN: TranslationDictionary = {
  ...
  profile: {
    roles: ['全栈开发者', 'A应用开发者', '内容创作者'],
    intro: "",
  },
  thought: '每个人都有自己与世界相处的方式',
  projects: [
    {
      name: 'E-Com Pilot',
    ...
    {
      name: 'Mini Store Go',
      description: '支持商品浏览、购物车、下单与后台管理的全栈电商商城',
      role: '全栈开发',
      period: '2026.06',
      techStack: 'React, TypeScript, Go, Vercel, RESTful API, Auth, E-commerce',
      highlights: [
        '实现商品搜索、分类筛选、详情页、购物车与结账流程，覆盖完整电商购买链路。',
        '搭建登录注册、收货地址、支付方式、订单详情与用户订单等账户相关页面。',
        '加入商品、用户、订单与概览等后台管理入口，支持商城运营管理场景。',
        '通过前后端分离结构组织商城业务，把商品、订单、评论和用户状态串成可演示的完整应用。',
      ],
    },
    {
      name: 'Rhymer',
      description: '面向节奏训练的 BPM 拍点练习工具',
      role: '前端开发',
      period: '2026.06',
      techStack: 'TypeScript, Web Audio API, Vercel, i18n, Responsive UI',
      highlights: [
        '实现可调 BPM、拍号、训练时长、校准值和节拍声开关，适配不同节奏练习场景。',
        '使用键盘空格或触屏输入记录击打时间，并实时反馈偏早、偏晚和命中等级。',
        '统计命中率、平均偏移与稳定度，帮助用户复盘整轮训练表现。',
        '支持中英文切换，并提供训练结束弹窗总结本轮节奏习惯。',
      ],
    },
  ],
  internships: [
